// canvas.js
/*
Модуль для управления канвасом и отрисовкой игрового поля.
Содержит функции для инициализации канваса, изменения его размера и запуска основного цикла отрисовки.
Также содержит функции для отрисовки фона и зданий, а также управления прогрессом улучшения зданий.
В этом модуле также обрабатывается логика отображения прогресса улучшения зданий и кнопки ускорения.
*/
